...
insert into book values (1002, 'Only Java', 22.22, 22);
insert into book values (1003, 'Java ABC', 33.33, 33);
insert into book values (1004, 'Java 123', 44.44, 44);
...
insert into author values (4, 'Kelvin Jones', 'kelvin@xzy.com');
